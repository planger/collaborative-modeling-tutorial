...
public class ExtLibraryProfileFactoryImpl extends EFactoryImpl implements ExtLibraryProfileFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case ExtLibraryProfilePackage.BOOK: return createBook();
			case ExtLibraryProfilePackage.LIBRARY: return createLibrary();
			case ExtLibraryProfilePackage.WRITER: return createWriter();
			case ExtLibraryProfilePackage.VIDEO_CASSETE: return createVideoCassete();
			case ExtLibraryProfilePackage.BOOK_ON_TAPE: return createBookOnTape();
			case ExtLibraryProfilePackage.PERIODICAL: return createPeriodical();
			case ExtLibraryProfilePackage.BORROWER: return createBorrower();
			case ExtLibraryProfilePackage.EMPLOYEE: return createEmployee();
			case ExtLibraryProfilePackage.BORROWS: return createBorrows();
			default:
