	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == Lendable.class) {
			switch (derivedFeatureID) {
				case ExtLibraryProfilePackage.CIRCULATING_ITEM__COPIES: return ExtLibraryProfilePackage.LENDABLE__COPIES;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == Lendable.class) {
			switch (baseFeatureID) {
				case ExtLibraryProfilePackage.LENDABLE__COPIES: return ExtLibraryProfilePackage.CIRCULATING_ITEM__COPIES;
				default: return -1;
			}
		}
