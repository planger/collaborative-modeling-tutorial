...
public class ExtLibraryProfilePackageImpl extends EPackageImpl implements ExtLibraryProfilePackage {
	 ...
	 * 
	 * <p>This method is used to initialize {@link ExtLibraryProfilePackage#eINSTANCE} when that field is accessed.
	...
	public static ExtLibraryProfilePackage init() {
		if (isInited) return (ExtLibraryProfilePackage)EPackage.Registry.INSTANCE.getEPackage(ExtLibraryProfilePackage.eNS_URI);
	...
	public void initializePackageContents() {
		...
		initEReference(getBorrows_Base_Dependency(), theUMLPackage.getDependency(), null, "base_Dependency", null, 1, 1, Borrows.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
